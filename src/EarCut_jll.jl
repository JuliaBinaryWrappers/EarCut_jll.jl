...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import EarCut_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5ae413db-bbd1-5e63-b57d-d24a61df00f5"))
platforms = [Pkg.Artifacts.unpack_platform(e, "EarCut", artifacts_toml) for e in artifacts["EarCut"]]
...
if best_platform === nothing
    @debug("Unable to load EarCut; unsupported platform $(triplet(platform_key_abi()))")
else
